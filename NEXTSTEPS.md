# Next Steps for ndx-ecog Extension for NWB:N

## Creating Your Extension

1. In a terminal, change directory into the new ndx-ecog directory.
...
4. Modify `src/create_extension_spec.py` to define your extension.
    ...
    - If you want to create any custom classes for interacting with the extension,
      ...
      - If present, the `src/pynwb` folder MUST contain the following:
        - `ndx-ecog` - Folder with the sources of the NWB extension
        - `ndx-ecog/__init__.py` - Python file that may be empty
...
`spec/ndx-ecog.namespace.yaml` and
`spec/ndx-ecog.extensions.yaml` files.
...
2. Start a git repository for your extension directory ndx-ecog
...
8. Make a release for the extension on GitHub with the version number specified. e.g. if version is 0.1.0, then this page should exist: https://github.com/bendichter/ndx-ecog/releases/tag/0.1.0

9. Publish your updated extension on PyPi.
    - Follow these directions: https://packaging.python.org/tutorials/packaging-projects/
    - You may need to modify `setup.py`
    - If your extension version is 0.1.0, then this page should exist: https://pypi.org/project/ndx-ecog/0.1.0
...
`staged-extensions/ndx-ecog`:

    ```bash
cp -r staged-extensions/example staged-extensions/ndx-ecog
```

11. Edit `staged-extensions/ndx-ecog/ndx-meta.yaml`
...
name: ndx-ecog
version: 0.1.0
src: https://github.com/bendichter/ndx-ecog
pip: https://pypi.org/project/ndx-ecog/
license: BSD 3-Clause
maintainers:
  - bendichter
```

12. Edit `staged-extensions/ndx-ecog/README.md`
to add information about your extension. You may copy it from
`ndx-ecog/README.md`.

  ```bash
cp ndx-ecog/README.md staged-extensions/ndx-ecog/README.md
```
...
ndx-ecog-feedstock will be created in the nwb-extensions
GitHub organization and you will be added as a maintainer for that repository.


## Updating Your Published Extension

1. Update your ndx-ecog GitHub repository.

2. Publish your updated extension on PyPi.

3. Fork the ndx-ecog-feedstock repository on GitHub.
